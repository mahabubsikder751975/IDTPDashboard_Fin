...
namespace IDTPDashboard.Web.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public DashboardController(IMenu_Repository repository,IParticularsRepository particularsRepository, IHRManagement_Repository repositoryHRManagement, IFinance_Repository repositoryFinance, ILanding_Repository repositoryLanding, IPR_Repository repositoryPR, IFAManagement_Repository repositoryFAManagement)
        {
            _repository = repository ?? throw new ArgumentNullException(nameof(repository));
            _particularsRepository = particularsRepository ?? throw new ArgumentNullException(nameof(particularsRepository));
            ...
            _repositoryLanding = repositoryLanding ?? throw new ArgumentNullException(nameof(repositoryLanding));
