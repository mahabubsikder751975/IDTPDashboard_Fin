#pragma checksum "C:\Software\IDTPDashboard_Fin\IDTPDashboard_Fin\IDTPDashboard.Web\Views\PowerDivChart\HRManagement_Dashboard.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dceb894b0f2a472a23d75645dc75e987fdf8adcd"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dceb894b0f2a472a23d75645dc75e987fdf8adcd", @"/Views/PowerDivChart/HRManagement_Dashboard.cshtml")]
    ...
    <div class=""col-md-6 p-1"">
        <div class=""card h-100"" >
            <div class=""card-body"">
                ...
                <div id=""G2L3DesignationLi");
            WriteLiteral(@"st"" style=""display:none;"">
        ...
        <div class=""card h-100"">
            <div class=""card-body"">
                ...
                <div id=""G8L3DesignationWiseEmployeeCount"" style=""display:none;"">
                    <table id=""tblG8L3DesignationWi");
            WriteLiteral(@"seEmployeeCount"" class=""table table-condensed table-striped table-bordered table-hover table-sm dt-nowrap"">
                        <thead>
                            <tr class=""table-active"">
                                <th scope=""col"">Designation</th>
                                <th scope=""col"">Number of Employee</th>
...
#nullable disable
            ...
            var dataSet3 = {
                label: 'Vacant Posts',
      ");
                WriteLiteral(@"          backgroundColor: '#698B69',
                data: y3Values
            };
...
#nullable disable
    ...
    <script type=""text/javascript"">
        ...
        function loadMain4() {
            ...
            els");
                WriteLiteral(@"e if ($('#retirementvsNewEmployee').is("":visible"")) {
                chart4.destroy();
                $('#btnBack4').hide();
                loadRetirementVsNewEmpChart();
            }
...
#nullable disable
            ...
            var yValues = retirementvsNewEmployee.map(v => v.retirement);
            var y2Values = retirementvsNewEmployee.map(a => a.newEmployee);
...
#nullable disable
    ...
    <script type=""text/javascript"">
        ...
        function loadMain6() {            
            ...
            else if ($('#G6L3MonthlySalarySummary')");
                WriteLiteral(@".is("":visible"")) {
...
#nullable disable
            ...
            canvas.onclick = function (evt) {
                ...
                console.log(canvas.onclick);
                if (activePoints6[0]) {
                    var chartData6 = activePoints6[0]['_ch");
                WriteLiteral(@"art'].config.data;
...
#nullable disable
            ...
            canvas.onclick = function (evt) {
                ...
                if (activePoints7[0]) {
                    var c");
                WriteLiteral(@"hartData7 = activePoints7[0]['_chart'].config.data;
                    ...
                    chart7.destroy();
                    //loadEmployeeJobStatus(label);
                    EmployeeJobStatusPieChart(label);
                }
